...
from conda_data import __version__ as version
from conda_data import commands as command_module
...
logger = logging.getLogger('conda-data')


def add_syslog_handler():
    hndlr = syslog_handler('conda-data')
